...
Tester
    ...
    public void runOpMode() {
        ...
        OcServo intakeDoor = robot.intakeDoor.intakeDoor;
        servos.add(intakeDoor);
        OcServo intakeBigTilt = robot.intakeBigTilt.intakeBigTilt;
        ...
        servoTestInfos = new ServoTestInfo[]{
                ...
                new ServoTestInfo(
                        intakeDoor,
                        robot.intakeDoor.OPEN,
                        robot.intakeDoor.CLOSED),
                // hSlides
                new ServoTestInfo(
                        intakeBigTilt,
                        robot.intakeBigTilt.TRANSFER,
                        robot.intakeBigTilt.OUT),
                new ServoTestInfo(
                        intakeSmallTilt,
